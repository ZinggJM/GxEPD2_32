...
//
// GxEPD2_32_U8T2_Fonts_Example : show use of U8G2_FOR_ADAFRUIT_GFX with GxEPD2
//
...
//
// Initial, experimental version GxEPD2_32_U8T2_Fonts_Example! for test use only
...
void helloArduino()
{
  ...
  do
  {
    ...
    u8g2_for_adafruit_gfx.println("Hello Arduino!");
  }
  while (display.nextPage());
